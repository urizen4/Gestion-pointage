...
<div class="teal chip  white-text" style="font-size:large;
  height:20%;
  font-family:Arial;
  font-weight:bold;">
   <?=$b['message']?>
   <a href="/ALAZHAR/public/js/recup.php?supprimer=<?=$b['idMessage']?>"><i class="material-icons small red-text pulse">delete</i></a>
</div>
<?php   
}
